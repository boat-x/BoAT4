...
int main(int argc, char **argv)
{
    ...
    BoatKeyInfo evm_info_recv;
    boat_key_get_info(evm_key, &evm_info_recv);
    const uint8_t *evm_sender   = evm_info_recv.address;
    const uint8_t *evm_receiver = evm_info_recv.address;  /* self-transfer */
